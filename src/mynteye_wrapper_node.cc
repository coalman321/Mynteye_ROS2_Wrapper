...
class MYNTEYEWrapper : public rclcpp::Node {
 public:
    ...
    void detectSubscribers() {
        ...
        bool left_color_sub = this->count_subscribers(pub_left_color.getTopic()) > 0;
        bool right_mono_sub = this->count_subscribers(pub_right_mono.getTopic()) > 0;
        bool right_color_sub = this->count_subscribers(pub_right_color.getTopic()) > 0;
        bool depth_sub = this->count_subscribers(pub_depth.getTopic()) > 0;
    ...
    sensor_msgs::msg::Temperature getTempMsgFromData(
        ...
        msg.header.stamp = stamp;
        msg.header.frame_id = frame_id;
        msg.temperature = imu_accel.temperature;
        return msg;
    }
    ...
    void publishMesh() {
        ...
        tf2::Quaternion quat;
        quat.setRPY(Pie / 2, 0.0, Pie);
        quat.normalize();
        geometry_msgs::msg::Quaternion q = tf2::toMsg(quat);
